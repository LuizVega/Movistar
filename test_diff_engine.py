...
def run_diff_tests():
    ...
    # 7. Prueba 7: Cliente Inexistente (CLI999)
    print("\n7. Test CLI999: Cliente No Encontrado")
    res7 = auditar_variacion_recibo("CLI999", "2026-07")
    print(json.dumps(res7, ensure_ascii=False, indent=2))
    assert res7["encontrado"] is False
    print("   [PASS] Prueba 7 OK.")

    # 8. Prueba 8: Interfaz Dify main()
    print("\n8. Test main() Dify interface")
    ...
    print("\n============================================================")
    print(">>> TODAS LAS 8 PRUEBAS DE DIFF ENGINE PASARON CON ÉXITO <<<")
    print("============================================================")
